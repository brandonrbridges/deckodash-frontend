...
export default class PublicOrder extends React.Component {
  constructor() {
    super()
  ...
  componentDidMount() {
    ...
    Axios.get(`http://localhost:8080/api/public/${ params.id }`)
      ...
      <>
        <Container fluid className='bg-dark mb-5'>
          <Container className='py-5'>
            <Row>
              <Col>
                <Badge variant='primary' className='badge-large mb-4'>QUOTE</Badge>
                <h1 className='text-white'>Deckorum</h1>
